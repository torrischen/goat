...
func WithReasoningSummary(summary string) Option {
	return func(o *options) {
		o.reasoningSummary = shared.ReasoningSummary(summary)
	}
...
func WithEncryptedReasoning(enabled bool) Option {
	return func(o *options) {
		o.includeEncryptedReasoning = enabled
	}
...
func WithServiceTier(tier string) Option {
	return func(o *options) {
		o.serviceTier = responses.ResponseNewParamsServiceTier(tier)
	}
...
func WithTruncation(strategy string) Option {
	return func(o *options) {
		o.truncation = responses.ResponseNewParamsTruncation(strategy)
	}
